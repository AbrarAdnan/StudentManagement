...
public class Insert31 {
	...
	private void initialize() {
		...
		btnexit.setBounds(632, 476, 137, 63);
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					stmt.executeUpdate("insert into studentinfo values('"+name+"','"+ID+"','"+GPA+"','"+OFA+"','"+OFB+"','"+OFmark+"'," + 
		...
		btnInsert.setBounds(793, 476, 137, 63);
