...
public class Insert41 {
	...
	private void initialize() {
		...
		lblstudentid.setBounds(829, 203, 122, 36);
		frame.getContentPane().add(lblstudentid);
		
		txtstudentid = new JTextField();
		txtstudentid.setFont(new Font("Tahoma", Font.BOLD, 18));
		txtstudentid.setColumns(10);
		txtstudentid.setBounds(963, 207, 204, 28);
		...
		txtsc2gp.setBounds(616, 476, 79, 35);
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					stmt.executeUpdate("insert into studentinfo41 values('"+name+"','"+id+"','"+gpa+"'," + 
