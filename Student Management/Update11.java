...
public class Update11 {
	...
	private void initialize() {
		...
		txtsc3m.setBounds(505, 524, 79, 35);
		...
		txtsc4m.setBounds(510, 584, 79, 35);
		...
		txtsc4gp.setBounds(601, 584, 79, 35);
		...
		lbltechnicalandcommunicativeenglishse.setBounds(0, 570, 432, 36);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Statement stmt=DatabaseConnection.getConnection().createStatement();
					stmt.executeUpdate("use kafi");
					stmt.executeUpdate("DELETE from studentinfo11 where id = '"+txtstudentid.getText()+"'");
		...
		btnUpdate.setBounds(862, 510, 137, 63);
